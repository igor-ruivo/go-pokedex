        ...
        <>
            <span className="images-container">
                <span className="main-image-container">
                    <img ref={ref} loading={lazy ? "lazy" : undefined} alt={pokemon.speciesName.replace("Shadow", translator(TranslatorKeys.Shadow, currentLanguage))} height={specificWidth ?? "100%"} width={specificWidth ?? "100%"} src={pokemon.imageUrl}/>
