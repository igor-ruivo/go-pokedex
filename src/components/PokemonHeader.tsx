...
const PokemonHeader = ({pokemonName, type1, type2, defaultTextColor, defaultBannerColor, whiteTextColor, darker, special}: IPokemonHeader) => {
    ...
    return <header className={`pokemonheader-header ${defaultBannerColor ? (darker ? "darker-banner-color" : (special ? "special-banner-color" : "banner-color")) : ""}`} style = {!defaultBannerColor ? {background: `linear-gradient(45deg, ${type1Color} 72%, ${type2Color} 72%)`} : {}}>
