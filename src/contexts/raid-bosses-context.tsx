...
const useFetchAllData: () => [IPostEntry, Dictionary<IPostEntry>[], IPostEntry, IPostEntry[], boolean, boolean, boolean, boolean, string, string, string, string] = () => {
