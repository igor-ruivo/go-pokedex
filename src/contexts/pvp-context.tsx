...
import { pvpokeRankings1500Url, pvpokeRankings2500Url, pvpokeRankingsRemixLittleUrl, pvpokeRankingsUrl } from '../utils/Configs';
...
const useFetchAllData: () => [Dictionary<IRankedPokemon>[], boolean, string] = () => {
    ...
    useEffect(() => {
        ...
        fetchRankLists([pvpokeRankings1500Url, pvpokeRankings2500Url, pvpokeRankingsUrl, pvpokeRankingsRemixLittleUrl], true, {signal: controller.signal}, (data: any, request: any) => mapRankedPokemon(data, request, gamemasterPokemon));
        return () => {
