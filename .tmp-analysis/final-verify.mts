...
const main = async () => {
	...
	// No leading `&` — these two blanket clauses ARE the primary selection
	// criteria (matching Tab 1's own convention of always starting with a bare
	// positive term, e.g. its dex list, never an empty leading `&`).
	let result = `0-2${A},0-2${D},0-2${S}`;
